...
public class Convolucion {
	...
	/**
	 * Aplica una operacion de convolución sobre la imagen pasada como 
	...
	public static BufferedImage aplicarFiltro(float filtro[][], BufferedImage imagen, int tratBordes ){
	    ...
	    if (filtro == null || filtro.length==0) throw new IllegalArgumentException("Debe pasarse algún filtro válido");
