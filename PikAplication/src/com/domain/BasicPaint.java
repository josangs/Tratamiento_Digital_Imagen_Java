...
public class BasicPaint extends JFrame {
    ...
    /** Image utilizada para guardar los cambios */
    private BufferedImage canvasImage;
    /** El panel principal de GUI para añadirlo a un JFrame o Applet */
    private JPanel gui;
    /** El color que llamamos cuando seleccionamos clear, texto u otra 
    ...
    /** Borrar el área de la imagen de entrada para pintar esta con el color actual. */
    ...
    /** Carga el color actual y refresca cualquier elemento necesario. */
    ...
    public static void main(String[] args) {
        Runnable r = new Runnable() {
            ...
            public void run() {
                ...
                panel.add(bp.getGui());
                panel.add(bp.getMenuBar(false));
                bp.getContentPane().add(panel);
                
                bp.setBounds(0, 0, 1280, 768);
