...
public class FiltroSobel {
	...
	public static final int Sx= 4, Sy = 5;
	...
	/**
	 * Las matrices de convolución de los distintos tipos 
	 * de filtros de Sobel.
	 */
	...
	/**
	 * Aplica el filtro de sobel a un imagen
	 * 
	 * @param imagen sobre la que se desea aplicar el filtro
	 * @param tipo de filtro de Sobel que se puede aplicar.
	 * Puede valer Sx_Der, Sx_Izq, Sy_Aba o Sy_Arr
	 * @param tratBordes
	 * @return la imagen resultante de aplicar el filtro de sobel o null en caso de fallo. 
	 */
	
	public BufferedImage aplicarSobel(BufferedImage imagen, int tipo, int tratBordes){
		...
		if (tipo<0) {
			...
			res = Convolucion.aplicarFiltro(filtros[tipo], imagen, tratBordes);
		}
		
		return res;
		}
	
	private  BufferedImage aplicarAbs(BufferedImage imagen, int tipo, int tratBordes){
		BufferedImage res = null;
		...
		BufferedImage aux1 = Convolucion.aplicarFiltro(filtros[tipo1], imagen, tratBordes);
		Raster rAux1 = aux1.getData();
		BufferedImage aux2 = Convolucion.aplicarFiltro(filtros[tipo2], imagen, tratBordes);
